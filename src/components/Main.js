...
function Main() {
    return ( 
            <div className='flex items-center justify-center gap--x-8 gap-y-14 mt-10 mb-8 w-full flex-wrap'>
                ...
                <div className='bg-blue-300 rounded-lg p-10 shadow-xl w-[1200px]'>   
